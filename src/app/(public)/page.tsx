    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      {toolOfTheDay && (
        <section className="py-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-2xl font-bold">Tool of the Day</h2>
          </div>
          <Link
            href={`/tools/${toolOfTheDay.slug}`}
            className="block bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-8 border border-primary/20 hover:border-primary/40 transition"
          >
            <div className="flex items-center gap-6">
              {toolOfTheDay.logo ? (
                <img src={toolOfTheDay.logo} alt="" className="w-20 h-20 rounded-2xl" />
              ) : (
              ...
              <div>
                <h3 className="text-2xl font-bold">{toolOfTheDay.name}</h3>
                <p className="text-muted-foreground mt-1">{toolOfTheDay.tagline}</p>
      ...
      <section className="py-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/tools?sort=recent" className="text-primary hover:underline">
            View all →
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
