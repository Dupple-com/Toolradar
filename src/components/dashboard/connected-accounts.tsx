...
export function ConnectedAccounts({ connectedProviders }: ConnectedAccountsProps) {
            ...
            >
              ...
              {isConnected ? (
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm bg-muted hover:bg-muted/80 rounded-lg transition"
                >
                  Connect
                </button>
              )}
