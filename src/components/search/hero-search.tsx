    ...
    <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto px-4 sm:px-0">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-11 sm:pl-14 pr-24 sm:pr-32 py-3 sm:py-4 text-base sm:text-lg bg-white border border-slate-200 rounded-xl sm:rounded-2xl shadow-lg shadow-slate-200/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-slate-400 text-slate-900"
        />
        <button
          type="submit"
          className="absolute right-2 top-1/2 -translate-y-1/2 px-4 sm:px-6 py-2 sm:py-2.5 bg-slate-900 text-white rounded-lg sm:rounded-xl hover:bg-slate-800 transition-colors font-medium text-sm sm:text-base"
        >
          Search
        </button>
      </div>
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 mt-4 text-sm text-slate-400">
        <span>Popular:</span>
